...
async function createEvent(req, res) {
  try {
    const r = await service.createEvent({ ...req.body, organizer_id: req.user.id });
...
async function updateEvent(req, res) {
  try {
    res.json(await service.updateEvent(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function register(req, res) {
  try {
    const r = await service.registerForEvent({ ...req.body, event_id: req.params.eventId });
    res.status(201).json(r);
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function updateRegistration(req, res) {
  try {
    res.json(await service.changeRegistrationStatus(req.params.id, req.body.status));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function createDocument(req, res) {
  try {
    const r = await service.createDocument({ ...req.body, uploader_id: req.user.id });
    res.status(201).json(r);
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function updatePartner(req, res) {
  try {
    res.json(await service.updatePartner(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function listQuickLinks(req, res) {
  try {
    res.json(await service.listQuickLinks());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function createQuickLink(req, res) {
  try {
    res.status(201).json(await service.createQuickLink(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function updateQuickLink(req, res) {
  try {
    res.json(await service.updateQuickLink(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function deleteQuickLink(req, res) {
  try {
    await service.deleteQuickLink(req.params.id);
    res.json({ success: true });
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function listAssets(req, res) {
  try {
    res.json(await service.listAssets(req.query.category));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function updateAsset(req, res) {
  try {
    res.json(await service.updateAsset(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function trackDownload(req, res) {
  try {
    res.json(await service.trackDownload(req.params.id));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function listGallery(req, res) {
  try {
    res.json(await service.listGallery(false));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function listAdminGallery(req, res) {
  try {
    res.json(await service.listGallery(true));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function updateGalleryItem(req, res) {
  try {
    res.json(await service.updateGalleryItem(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function listSubscribers(req, res) {
  try {
    res.json(await service.listSubscribers());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function subscribe(req, res) {
  try {
    res.status(201).json(await service.subscribe(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function createRegistration(req, res) {
  try {
    const r = await service.createRegistration({ ...req.body, user_id: req.user.id });
    res.status(201).json(r);
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function listHomeSlides(req, res) {
  try {
    res.json(await service.listHomeSlides());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function createHomeSlide(req, res) {
  try {
    res.status(201).json(await service.createHomeSlide(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function updateHomeSlide(req, res) {
  try {
    res.json(await service.updateHomeSlide(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function deleteHomeSlide(req, res) {
  try {
    await service.deleteHomeSlide(req.params.id);
    res.json({ success: true });
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function getHomeHero(req, res) {
  try {
    res.json(await service.getHomeHero());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function upsertHomeHero(req, res) {
  try {
    res.json(await service.upsertHomeHero(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function listHomeStats(req, res) {
  try {
    res.json(await service.listHomeStats());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function createHomeStat(req, res) {
  try {
    res.status(201).json(await service.createHomeStat(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function updateHomeStat(req, res) {
  try {
    res.json(await service.updateHomeStat(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function deleteHomeStat(req, res) {
  try {
    await service.deleteHomeStat(req.params.id);
    res.json({ success: true });
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function listHomeServices(req, res) {
  try {
    res.json(await service.listHomeServices());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function createHomeService(req, res) {
  try {
    res.status(201).json(await service.createHomeService(req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function updateHomeService(req, res) {
  try {
    res.json(await service.updateHomeService(req.params.id, req.body));
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
async function deleteHomeService(req, res) {
  try {
    await service.deleteHomeService(req.params.id);
    res.json({ success: true });
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function listTestimonials(req, res) {
  try {
    res.json(await service.listTestimonials());
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
}
...
async function submitForm(req, res) {
  try {
    const r = await service.submitForm(req.body);
    res.status(201).json(r);
  } catch (err) {
    res.status(500).json({ error: err.message });
  }
...
async function listPlugins(req, res) {
  try {
    ...
    console.error('[CMS] listPlugins error:', err);
    res.status(500).json({ error: err.message });
  }
}
async function listThemes(req, res) {
  try {
    res.json(await service.listThemes());
  } catch (err) {
    console.error('[CMS] listThemes error:', err);
    res.status(500).json({ error: err.message });
  }
}
