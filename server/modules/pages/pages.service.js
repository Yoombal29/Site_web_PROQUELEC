...
async function deletePage(id) {
  ...
  try {
    sendSseEvent('page:deleted', { id });
  } catch (e) {
    console.warn('SSE failed (page:deleted)', e);
  }
}
  ...
  const HOMEPAGE_STRUCTURE = [
    ...
    },
    {
      ...
      props: {
        ...
        subtitle: "Depuis 1995, PROQUELEC s'engage.",
        missionTitle: 'Notre Mission',
        missionDesc: 'Promouvoir la sécurité et la conformité normative.',
        visionTitle: 'Notre Vision',
        visionDesc: 'Devenir la référence nationale absolue.',
