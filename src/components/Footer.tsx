...
export const Footer = () => {
  ...
  const footerStyle = {
    backgroundColor: settings?.secondary_color || '#054393',
  ...
  return (
    <footer style={footerStyle} className="mt-8 sm:mt-12 md:mt-16 relative overflow-hidden">
      {/* Gradient overlay */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 sm:mb-16">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold" style={{ fontFamily: settings?.font_family }}>
                  {settings?.site_name || "PROQUELEC"}
                </h3>
              </div>
              <p className="text-xs sm:text-sm opacity-75 max-w-xs" style={{ fontFamily: settings?.font_family }}>
          ...
          <div>
            <h4 className="text-base sm:text-lg font-semibold mb-5 flex items-center gap-2" style={{ fontFamily: settings?.font_family }}>
              Navigation
            </h4>
          ...
          {/* Colonne 3: Services */}
          <div>
            <h4 className="text-base sm:text-lg font-semibold mb-5" style={{ fontFamily: settings?.font_family }}>
              Services
            </h4>
            <ul className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <p className="text-xs sm:text-sm opacity-70 text-center sm:text-left" style={{ fontFamily: settings?.font_family }}>
