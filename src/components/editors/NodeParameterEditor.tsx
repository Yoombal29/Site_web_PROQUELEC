    ...
    <div className="space-y-4">
      ...
      <div className="pt-2 border-t border-red-600">
        <button
          ...
          disabled={isDeleting}
          className="w-full px-3 py-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-lg transition-all" aria-label="Action">
      ...
      <div className="flex gap-2 pt-2 border-t border-slate-600">
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="flex-1 px-3 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-lg transition-all" aria-label="Action">
...
const SourceEditor: React.FC<{values: unknown;onChange: (v: unknown) => void;}> = ({ values, onChange }) =>
<div className="space-y-3">
    ...
    className="w-full px-3 py-2 bg-slate-700 text-white border border-slate-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30"
    title="Type de source électrique">
    ...
    className="w-full px-3 py-2 bg-slate-700 text-white border border-slate-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30"
    title="Type de réseau (Monophasé/Triphasé)">
