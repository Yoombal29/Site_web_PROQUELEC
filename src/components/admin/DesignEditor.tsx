...
import {
  Palette, Layout, Eye, Code, Sparkles, Type,
  Trash2, Plus } from
'lucide-react';
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <button
                  ...
                  className={`p-4 rounded-lg border-2 transition ${page.design_options.layout === template.id ?
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <style dangerouslySetInnerHTML={{
                    __html: `
                    .design-editor-preview-box {
                      background-color: ${design.background_color};
                      color: ${design.text_color};
                      border-color: ${design.accent_color};
                    }
                  ` }} />
                  <div
                    className="mt-2 p-6 rounded border-2 text-center font-semibold design-editor-preview-box">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded">
                <style dangerouslySetInnerHTML={{
                  __html: `
                  .preview-heading-font { font-family: ${design.heading_font || 'inherit'}, sans-serif; }
                  .preview-body-font { font-family: ${design.body_font || 'inherit'}, sans-serif; }
                ` }} />
                <div className="preview-heading-font">
                  <h2 className="text-2xl font-bold mb-2">Ceci est un exemple de titre</h2>
                </div>
                <div className="preview-body-font">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                className="w-full"
                variant="outline"
                title="Ajouter une nouvelle section personnalisée">
