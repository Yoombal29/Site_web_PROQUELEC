...
import { Charge } from '@/stores/GraphStore';
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {presets.map((preset, index) => (
                            <button
                              ...
                              className="text-left p-2 bg-slate-50 border border-slate-200 rounded-md hover:bg-blue-50 hover:border-blue-200 transition-colors text-xs"
                            >
