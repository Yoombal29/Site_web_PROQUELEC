...
export const HeadingBlock = (props: any) => {
  ...
  const {
    ...
    selected,
    actions: { setProp },
  } = useNode((n: any) => ({ selected: n.events.selected }));
  ...
  return React.createElement(
    Tag,
    {
      ...
      style: {
        ...
        fontWeight,
        lineHeight,
        letterSpacing: letterSpacing ? letterSpacing + 'px' : void 0,
        ...u.style,
      },
    ...
    selected
      ? React.createElement(InlineTextEditor, {
          value: displayVal,
          onChange: (v: string) => setProp((p: any) => (p.text = v)),
          tagName: Tag,
          style: { fontSize, textAlign, color, fontWeight, lineHeight },
        })
      : displayVal,
  );
};
const HeadingSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <Row>
        <Label label="Texte" />
        <Input value={text} onChange={(e: any) => setProp((p: any) => (p.text = e.target.value))} />
      </Row>
      <Row>
        <Label label="Niveau" />
        <Select
      ...
      <Grid2>
        <Row>
          <Label label="Taille (px)" />
          <Input
            type="number"
            value={fontSize}
            onChange={(e: any) => setProp((p: any) => (p.fontSize = parseInt(e.target.value)))}
          />
        </Row>
        <Row>
          <Label label="Poids" />
          <Select
            value={fontWeight}
            onChange={(e: any) => setProp((p: any) => (p.fontWeight = e.target.value))}
            options={[
      ...
      <Row>
        ...
        <Select
          value={textAlign}
          onChange={(e: any) => setProp((p: any) => (p.textAlign = e.target.value))}
          options={[
      ...
      <Row>
        ...
        <Color
          value={color}
          onChange={(e: any) => setProp((p: any) => (p.color = e.target.value))}
        />
      </Row>
      <Grid2>
        <Row>
          <Label label="Interligne" />
          <Input
            type="number"
            step={0.1}
            value={lineHeight}
            onChange={(e: any) => setProp((p: any) => (p.lineHeight = e.target.value))}
          />
        </Row>
        <Row>
          <Label label="Espacement (px)" />
          <Input
            type="number"
            value={letterSpacing}
            onChange={(e: any) =>
              setProp((p: any) => (p.letterSpacing = parseInt(e.target.value) || 0))
            }
          />
        </Row>
      </Grid2>
...
export const ListBlock = (props: any) => {
  ...
  return React.createElement(
    Tag,
    {
      ...
      style: { paddingLeft: '1.5em', ...u.style },
      className: 'proquelec-builder-node ' + u.className,
    },
    items.map((item: string, i: number) =>
      React.createElement(
        'li',
        { key: i, className: 'text-slate-700 mb-1' },
    ...
    <div className="space-y-3">
      <Row>
        ...
        <Select
          ...
          onChange={(e: any) => setProp((p: any) => (p.ordered = e.target.value === 'ordered'))}
          options={[
            { value: 'unordered', label: 'Puce' },
            { value: 'ordered', label: 'Numérotée' },
          ]}
        />
      </Row>
      <Row>
        <Label label="Éléments (1 par ligne)" />
        <Textarea
          rows={5}
          value={(items || []).join('\n')}
          onChange={(e: any) =>
            setProp(
              (p: any) => (p.items = e.target.value.split('\n').filter((s: string) => s.trim())),
            )
          }
        />
      </Row>
...
ListBlock.craft = {
  displayName: 'Liste',
  props: { items: ['Élément 1', 'Élément 2', 'Élément 3'], ordered: false },
...
export const QuoteBlock = (props: any) => {
  const {
    quote = "Le meilleur moyen de prédire l'avenir est de le créer.",
  ...
  return (
    <figure
      ...
      style={{ borderLeft: '4px solid ' + accentColor, padding: '16px 20px', ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      <blockquote className="text-lg italic text-slate-700 mb-3 font-medium">
        "{resolveDynamicContent(quote)}"
      </blockquote>
      <figcaption className="text-sm">
        <strong>{resolveDynamicContent(author)}</strong>
        {role ? <span className="text-slate-500"> — {resolveDynamicContent(role)}</span> : null}
      </figcaption>
    </figure>
  );
};
    ...
    <div className="space-y-3">
      <Row>
        ...
        <Textarea
          rows={3}
          value={quote}
          onChange={(e: any) => setProp((p: any) => (p.quote = e.target.value))}
        />
      </Row>
      <Row>
        <Label label="Auteur" />
        <Input
          value={author}
          onChange={(e: any) => setProp((p: any) => (p.author = e.target.value))}
        />
      </Row>
      <Row>
        <Label label="Rôle" />
        <Input value={role} onChange={(e: any) => setProp((p: any) => (p.role = e.target.value))} />
      </Row>
      <Row>
        <Label label="Accent" />
        <Color
...
export const TableBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={u.style}
      className={'proquelec-builder-node overflow-x-auto ' + u.className}
    >
      <table className="w-full text-left border-collapse">
        ...
        <tbody>
          {rows.map((row: string[], ri: number) => (
            <tr key={ri} style={{ background: striped && ri % 2 === 1 ? '#f8fafc' : 'white' }}>
              {row.map((c: string, ci: number) => (
                <td
                  key={ci}
                  style={{ border: '1px solid ' + borderColor, padding: '8px 12px', fontSize: 13 }}
                >
                  {resolveDynamicContent(c)}
                </td>
              ))}
            </tr>
          ))}
...
const TableSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <Row>
        <Label label="En-têtes (séparés par |)" />
        <Input
          value={headers.join(' | ')}
          onChange={(e: any) =>
            setProp(
              (p: any) => (p.headers = e.target.value.split('|').map((s: string) => s.trim())),
            )
          }
        />
      </Row>
      <Row>
        <Label label="Lignes (| cellules, ; lignes)" />
        <Textarea
          rows={4}
      ...
      <Flex>
        <label className="text-xs text-slate-400">
          <input
            type="checkbox"
            checked={striped}
            onChange={(e: any) => setProp((p: any) => (p.striped = e.target.checked))}
            className="mr-1"
          />
          Rayé
        </label>
      ...
      <Grid2>
        <Row>
          <Label label="Couleur en-tête" />
          <Color
            value={headerBg}
            onChange={(e: any) => setProp((p: any) => (p.headerBg = e.target.value))}
          />
        </Row>
        <Row>
          <Label label="Texte en-tête" />
          <Color
            value={headerColor}
            onChange={(e: any) => setProp((p: any) => (p.headerColor = e.target.value))}
          />
        </Row>
      </Grid2>
    </div>
    ...
    >
      ...
      {code.split('\n').map((line: string, i: number) => (
        <div key={i} className="whitespace-pre">
          {showLineNumbers && (
            <span className="opacity-40 mr-4 select-none">{String(i + 1).padStart(3, ' ')}</span>
          )}
          <span>{line}</span>
        </div>
      ))}
  ...
  return (
    <div className="space-y-3">
      <Row>
        ...
        <Input
          value={language}
          onChange={(e: any) => setProp((p: any) => (p.language = e.target.value))}
        />
      </Row>
      <Row>
        <Label label="Code" />
        <Textarea
          rows={8}
          value={code}
          onChange={(e: any) => setProp((p: any) => (p.code = e.target.value))}
        />
      </Row>
      <Flex>
        <label className="text-xs text-slate-400">
          <input
            ...
            onChange={(e: any) => setProp((p: any) => (p.showLineNumbers = e.target.checked))}
            className="mr-1"
          />
          N° lignes
        </label>
        <Select
          value={theme}
          onChange={(e: any) => setProp((p: any) => (p.theme = e.target.value))}
          options={[
...
CodeBlock.craft = {
  ...
  related: { settings: CodeSettings },
};

// ── 6. BlockquoteBlock ──
export const BlockquoteBlock = (props: any) => {
  const {
    text = 'Texte de la citation longue…',
  ...
  return (
    <blockquote
      ...
      className={'proquelec-builder-node ' + u.className}
    >
      {resolveDynamicContent(text)}
    </blockquote>
  );
};
BlockquoteBlock.craft = {
  displayName: 'Bloc Citation',
  props: {
    text: 'Texte de la citation longue…',
    backgroundColor: '#f1f5f9',
    borderColor: '#2563eb',
...
HighlightedTextBlock.craft = {
  displayName: 'Texte surligné',
  props: { text: 'Texte surligné', highlightColor: '#fef08a', textColor: '#0f172a', fontSize: 18 },
  related: { settings: AutoSettingsPanel },
};
...
export const DropCapBlock = (props: any) => {
  const {
    text = 'Lettre initiale en grande taille.',
    dropCapSize = 60,
    dropCapColor = '#2563eb',
  } = props;
  const {
...
DropCapBlock.craft = {
  displayName: 'Lettrine',
  props: { text: 'Lettre initiale en grande taille.', dropCapSize: 60, dropCapColor: '#2563eb' },
  related: { settings: AutoSettingsPanel },
};
  ...
  return (
    <aside
      ...
      style={{
        float: align as any,
        width,
        margin: align === 'right' ? '0 0 16px 24px' : '0 24px 16px 0',
        fontSize,
        color: accentColor,
        fontWeight: 700,
        lineHeight: 1.3,
        fontStyle: 'italic',
        borderLeft: align === 'left' ? '3px solid ' + accentColor : 'none',
        borderRight: align === 'right' ? '3px solid ' + accentColor : 'none',
        padding: '0 16px',
        ...u.style,
      }}
      className={'proquelec-builder-node ' + u.className}
...
PullquoteBlock.craft = {
  displayName: 'Citation flottante',
  props: {
    text: 'Citation flottante.',
    align: 'right',
    width: '40%',
...
export const DefinitionListBlock = (props: any) => {
  ...
  return (
    <dl
      ...
      style={u.style}
      className={'proquelec-builder-node space-y-3 ' + u.className}
    >
      {items.map(([term, def]: string[], i: number) => (
        <div key={i}>
          <dt className="font-bold text-slate-900">{resolveDynamicContent(term)}</dt>
          <dd className="text-slate-600 ml-4 mt-0.5">{resolveDynamicContent(def)}</dd>
        </div>
      ))}
    </dl>
  );
};
DefinitionListBlock.craft = {
  displayName: 'Liste définitions',
  props: {
    items: [
      ['Terme 1', 'Déf 1'],
      ['Terme 2', 'Déf 2'],
...
export const AddressBlock = (props: any) => {
  const {
    company = 'PROQUELEC',
    street = 'Immeuble Coumba Castel, 12 rue Saint-Michel, 4e étage',
    city = 'Dakar',
  ...
  return (
    <address
      ...
      style={{ fontStyle: 'normal', lineHeight: 1.8, ...u.style }}
      className={'proquelec-builder-node not-italic ' + u.className}
    >
      ...
      <a href={'tel:' + phone} className="block text-blue-600 hover:underline">
        {phone}
      </a>
      <a href={'mailto:' + email} className="block text-blue-600 hover:underline">
        {email}
      </a>
    </address>
  );
...
const ImageCarouselSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <Row>
        <Label label="URL images (1 par ligne)" />
        <Textarea
          rows={4}
          value={images.join('\n')}
          onChange={(e: any) =>
      ...
      <Flex>
        <label className="text-xs text-slate-400">
          <input
            type="checkbox"
            checked={autoPlay}
            onChange={(e: any) => setProp((p: any) => (p.autoPlay = e.target.checked))}
            className="mr-1"
          />
          Auto
        </label>
        <label className="text-xs text-slate-400">
          <input
            type="checkbox"
            checked={showDots}
            onChange={(e: any) => setProp((p: any) => (p.showDots = e.target.checked))}
            className="mr-1"
          />
          Points
        </label>
        <label className="text-xs text-slate-400">
          <input
            type="checkbox"
            checked={showArrows}
            onChange={(e: any) => setProp((p: any) => (p.showArrows = e.target.checked))}
            className="mr-1"
          />
          Flèches
        </label>
      ...
      <Row>
        <Label label="Intervalle (ms)" />
        <Input
          type="number"
          value={interval}
          onChange={(e: any) => setProp((p: any) => (p.interval = parseInt(e.target.value)))}
        />
      </Row>
    </div>
  );
...
export const VideoPopupBlock = (props: any) => {
  ...
  return (
    ...
    >
      ...
      >
        {thumbnail ? (
          <img src={thumbnail} alt="" style={{ width: 320, height: 180, objectFit: 'cover' }} />
        ) : (
          <div
            style={{
              width: 320,
...
VideoPopupBlock.craft = {
  displayName: 'Popup Vidéo',
  props: {
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    buttonLabel: '▶ Lire la vidéo',
    width: 800,
...
export const ImageHotspotBlock = (props: any) => {
  const {
    image = 'https://placehold.co/600x400/1e293b/ffffff?text=Hotspot',
    hotspots = [
      { x: 30, y: 40, label: 'Point 1', desc: 'Description du point 1' },
      { x: 70, y: 60, label: 'Point 2', desc: 'Description du point 2' },
    ],
  } = props;
  const {
    connectors: { connect, drag },
  ...
  return (
    <div
      ...
      style={{ position: 'relative', display: 'inline-block', ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
        ...
        >
          ...
          {active === i && (
            ...
            >
              ...
              {h.desc ? <span className="block text-slate-300 font-normal">{h.desc}</span> : null}
            </div>
          )}
        </div>
      ))}
...
ImageHotspotBlock.craft = {
  displayName: 'Image Hotspots',
  props: {
    image: 'https://placehold.co/600x400/1e293b/ffffff?text=Hotspot',
    hotspots: [
      { x: 30, y: 40, label: 'Point 1', desc: 'Description' },
      { x: 70, y: 60, label: 'Point 2', desc: 'Description' },
    ],
  },
  related: { settings: AutoSettingsPanel },
};
...
export const ImageComparisonBlock = (props: any) => {
  const {
    imageBefore = 'https://placehold.co/600x400/94a3b8/ffffff?text=Avant',
    imageAfter = 'https://placehold.co/600x400/2563eb/ffffff?text=Après',
    labelBefore = 'Avant',
    labelAfter = 'Après',
  } = props;
  const {
  ...
  const handleMove = (e: React.MouseEvent) => {
    ...
    if (r) setPos(Math.max(0, Math.min(100, ((e.clientX - r.left) / r.width) * 100)));
  };
  return (
    <div
      ref={(r: any) => {
...
ImageComparisonBlock.craft = {
  displayName: 'Comparaison Image',
  props: {
    imageBefore: 'https://placehold.co/600x400/94a3b8/ffffff?text=Avant',
    imageAfter: 'https://placehold.co/600x400/2563eb/ffffff?text=Après',
    labelBefore: 'Avant',
...
export const MasonryGalleryBlock = (props: any) => {
  const {
    images = [
      'https://placehold.co/300x400/2563eb/ffffff?text=1',
      'https://placehold.co/300x500/1e293b/ffffff?text=2',
      'https://placehold.co/300x300/475569/ffffff?text=3',
      'https://placehold.co/300x450/0f172a/ffffff?text=4',
    ],
    columns = 3,
    gap = 8,
  } = props;
...
MasonryGalleryBlock.craft = {
  displayName: 'Galerie Masonry',
  props: {
    images: [
      'https://placehold.co/300x400/2563eb/ffffff?text=1',
      'https://placehold.co/300x500/1e293b/ffffff?text=2',
...
export const LottieBlock = (props: any) => {
  const {
    animationUrl = 'https://assets5.lottiefiles.com/packages/lf20_sZTNZn.json',
    width = 300,
    height = 300,
  } = props;
  const {
...
AudioBlock.craft = {
  displayName: 'Audio',
  props: { url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', title: 'Audio' },
  related: { settings: AutoSettingsPanel },
};
...
export const FileDownloadBlock = (props: any) => {
  ...
  return (
    <a
      ...
      className={'proquelec-builder-node hover:bg-slate-100 transition ' + u.className}
    >
      <span style={{ fontSize: 24 }}>{icon}</span>
      <div>
        <span className="font-medium text-sm">{label}</span>
        {fileSize && <span className="block text-xs text-slate-500">{fileSize}</span>}
      </div>
      <span style={{ marginLeft: 'auto', color: accentColor, fontSize: 14 }}>↓</span>
    </a>
  );
};
FileDownloadBlock.craft = {
...
export const ThumbnailGalleryBlock = (props: any) => {
  const {
    images = [
      'https://placehold.co/600x400/2563eb/ffffff?text=1',
      'https://placehold.co/600x400/1e293b/ffffff?text=2',
      'https://placehold.co/600x400/475569/ffffff?text=3',
    ],
    gap = 8,
  } = props;
  const {
...
ThumbnailGalleryBlock.craft = {
  displayName: 'Galerie Vignettes',
  props: {
    images: [
      'https://placehold.co/600x400/2563eb/ffffff?text=1',
      'https://placehold.co/600x400/1e293b/ffffff?text=2',
...
export const FlipBoxBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ perspective: 1000, height, cursor: 'pointer', ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      <div
        style={{
      ...
      >
        ...
        >
          {resolveDynamicContent(frontText)}
        </div>
        <div
          style={{
            position: 'absolute',
        ...
        >
          {resolveDynamicContent(backText)}
        </div>
      </div>
    </div>
  );
        ...
        <div key={i}>
          <div style={box}>
            <div style={{ fontSize: 28, fontWeight: 700, lineHeight: 1.2 }}>
              {String(o.v).padStart(2, '0')}
            </div>
            <div style={{ fontSize: 11, opacity: 0.7, marginTop: 2 }}>{o.l}</div>
          </div>
        </div>
      ))}
    </div>
...
export const TestimonialCarouselBlock = (props: any) => {
  const {
    items = [
      { text: 'Excellent service !', author: 'Jean Dupont', role: 'CEO', avatar: '' },
      { text: 'Produits de grande qualité.', author: 'Marie Martin', role: 'CTO', avatar: '' },
    ],
    bgColor = '#f8fafc',
    textColor = '#0f172a',
    accentColor = '#2563eb',
  ...
  return (
    <div
      ...
      style={{ background: bgColor, borderRadius: 12, padding: 32, ...u.style }}
      className={'proquelec-builder-node relative ' + u.className}
    >
      {items.map((item: any, i: number) => (
        <div key={i} style={{ display: i === current ? 'block' : 'none', textAlign: 'center' }}>
          ...
          <div>
            ...
            <p style={{ color: textColor, fontWeight: 600, fontSize: 14 }}>{item.author}</p>
            {item.role && (
              <p style={{ color: textColor, opacity: 0.6, fontSize: 12 }}>{item.role}</p>
            )}
          </div>
        </div>
      ))}
          ...
          {items.map((_: any, i: number) => (
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                background: i === current ? accentColor : '#cbd5e1',
                padding: 0,
              }}
            />
          ))}
...
TestimonialCarouselBlock.craft = {
  displayName: 'Carrousel Témoignages',
  props: {
    items: [
      { text: 'Excellent service !', author: 'Jean Dupont', role: 'CEO' },
      { text: 'Produits de grande qualité.', author: 'Marie Martin', role: 'CTO' },
    ],
    bgColor: '#f8fafc',
    textColor: '#0f172a',
    accentColor: '#2563eb',
...
export const FAQBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={u.style}
      className={
        'proquelec-builder-node divide-y divide-slate-200 border border-slate-200 rounded-lg overflow-hidden ' +
        u.className
      }
    >
      {items.map((item: any, i: number) => (
        <div key={i}>
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              border: 'none',
              background: open === i ? '#f8fafc' : 'white',
              cursor: 'pointer',
              fontWeight: 600,
              fontSize: 14,
              color: open === i ? activeColor : '#0f172a',
              display: 'flex',
          ...
          {open === i && (
            <div
              style={{ padding: '0 16px 12px', fontSize: 13, color: '#475569', lineHeight: 1.7 }}
            >
              {item.a}
            </div>
          )}
...
export const ModalBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={u.style}
      className={'proquelec-builder-node inline-block ' + u.className}
    >
      <button
        onClick={() => setOpen(true)}
        style={{
...
export const ToggleBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ border: '1px solid #e2e8f0', borderRadius: 8, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      <button
...
ToggleBlock.craft = {
  displayName: 'Toggle',
  props: { label: 'Afficher plus', content: 'Contenu dépliable…', openByDefault: false },
  related: { settings: AutoSettingsPanel },
};
...
export const TimelineBlock = (props: any) => {
  const {
    items = [
      { year: '2023', title: 'Étape 1', desc: "Description de l'étape 1." },
      { year: '2024', title: 'Étape 2', desc: "Description de l'étape 2." },
    ],
    accentColor = '#2563eb',
  } = props;
  const {
    ...
    >
      {items.map((item: any, i: number) => (
        ...
        >
          ...
          <div>
            <span style={{ fontSize: 12, color: accentColor, fontWeight: 600 }}>{item.year}</span>
            <h4 style={{ margin: '2px 0 4px', fontSize: 15, fontWeight: 600 }}>{item.title}</h4>
...
TimelineBlock.craft = {
  ...
  props: {
    items: [
      { year: '2023', title: 'Étape 1', desc: 'Description' },
      { year: '2024', title: 'Étape 2', desc: 'Description' },
    ],
    accentColor: '#2563eb',
  },
  related: { settings: AutoSettingsPanel },
...
export const StepsBlock = (props: any) => {
  const {
    items = [
      { title: 'Étape 1', desc: "Description de l'étape 1." },
      { title: 'Étape 2', desc: "Description de l'étape 2." },
      { title: 'Étape 3', desc: "Description de l'étape 3." },
    ],
    accentColor = '#2563eb',
    layout = 'horizontal',
  } = props;
    ...
    >
      {items.map((item: any, i: number) => (
        ...
        >
          ...
          <div>
            <h4 style={{ fontSize: 14, fontWeight: 600, margin: '0 0 2px' }}>{item.title}</h4>
...
StepsBlock.craft = {
  ...
  props: {
    items: [
      { title: 'Étape 1', desc: 'Desc' },
      { title: 'Étape 2', desc: 'Desc' },
      { title: 'Étape 3', desc: 'Desc' },
    ],
    accentColor: '#2563eb',
    layout: 'horizontal',
  },
...
const TeamMembersSettings = () => {
  ...
  const [local, setLocal] = useState<any[]>(members || []);
  const sync = (m: any[]) => {
    setLocal(m);
    setProp((p: any) => (p.members = m));
  };
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Colonnes" />
        <SettingsInput
          type="number"
          min={1}
          max={6}
          value={columns}
          onChange={(e: any) => setProp((p: any) => (p.columns = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Espacement" />
        <SettingsInput
          type="number"
          min={4}
          max={60}
          value={gap}
          onChange={(e: any) => setProp((p: any) => (p.gap = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <div className="border-t border-slate-700 pt-3">
        <div className="flex items-center justify-between mb-2">
          <SettingsLabel label={`Membres (${local.length})`} />
          <button
            onClick={() =>
              sync([...local, { name: 'Nouveau', role: 'Rôle', photo: '', bio: 'Description' }])
            }
            className="text-[10px] px-2 py-1 rounded bg-indigo-500/20 text-indigo-300 hover:bg-indigo-500/30"
          >
            + Ajouter
          </button>
        </div>
        <div className="space-y-2 max-h-60 overflow-y-auto">
          {local.map((m: any, i: number) => (
            <div
              key={i}
              className="p-2 rounded-lg bg-slate-800/50 border border-slate-700 space-y-1"
            >
...
export const TeamMembersGridBlock = (props: any) => {
  const {
    members = [
      { name: 'Alice Dupont', role: 'CEO', photo: '', bio: 'Description…' },
      { name: 'Bob Martin', role: 'CTO', photo: '', bio: 'Description…' },
    ],
    columns = 3,
    gap = 20,
  } = props;
  ...
  return (
    <div
      ...
      style={{
        display: 'grid',
        gridTemplateColumns:
          'repeat(auto-fill,minmax(' + (columns > 3 ? '250' : '280') + 'px,1fr))',
        gap,
        ...u.style,
      }}
      className={'proquelec-builder-node ' + u.className}
    >
      {members.map((m: any, i: number) => (
        <div
          key={i}
          style={{ textAlign: 'center', padding: 16, background: '#f8fafc', borderRadius: 8 }}
        >
          {m.photo ? (
            <img
              src={m.photo}
          ...
          <h4 style={{ fontSize: 15, fontWeight: 600, margin: '0 0 2px' }}>{m.name}</h4>
          <p style={{ fontSize: 12, color: '#2563eb', fontWeight: 500, margin: '0 0 6px' }}>
            {m.role}
          </p>
          <p style={{ fontSize: 12, color: '#475569', lineHeight: 1.5, margin: 0 }}>{m.bio}</p>
        </div>
      ))}
    </div>
  );
};
TeamMembersGridBlock.craft = {
  displayName: 'Membres Équipe',
  props: {
    members: [
      { name: 'Alice Dupont', role: 'CEO', photo: '', bio: 'Description…' },
      { name: 'Bob Martin', role: 'CTO', photo: '', bio: 'Description…' },
  ...
  related: { settings: TeamMembersSettings },
};
// ─────────────────────────────────────────────
// MARKETING BLOCKS
// ─────────────────────────────────────────────
...
export const CallToActionBlock = (props: any) => {
  ...
  return (
    <div
      ...
      className={'proquelec-builder-node ' + u.className}
    >
      <div style={{ textAlign: isH ? 'left' : 'center' }}>
        <h3 style={{ margin: '0 0 6px', fontSize: 24, fontWeight: 700 }}>
          {resolveDynamicContent(title)}
        </h3>
        <p style={{ margin: 0, opacity: 0.9, fontSize: 14, lineHeight: 1.6 }}>
          {resolveDynamicContent(description)}
        </p>
      </div>
      <a
        href={buttonUrl}
...
export const PriceListBlock = (props: any) => {
  const {
    items = [
      { name: 'Pack Standard', price: '49€', desc: 'Description du pack', featured: false },
      { name: 'Pack Premium', price: '99€', desc: 'Description du pack', featured: true },
    ],
    columns = 3,
  } = props;
  const {
    ...
    >
      {items.map((item: any, i: number) => (
        <div
          key={i}
          style={{
            border: item.featured ? '2px solid #2563eb' : '1px solid #e2e8f0',
            borderRadius: 12,
            padding: 24,
            textAlign: 'center',
            position: 'relative',
            background: item.featured ? '#f8fafc' : 'white',
          }}
        >
          {item.featured && (
            <span
          ...
          <div style={{ fontSize: 32, fontWeight: 700, color: '#0f172a', margin: '8px 0' }}>
            {item.price}
          </div>
          ...
          <button
            style={{
              width: '100%',
              background: item.featured ? '#2563eb' : '#f1f5f9',
              color: item.featured ? 'white' : '#0f172a',
              border: 'none',
              padding: '8px 16px',
              borderRadius: 8,
              cursor: 'pointer',
...
PriceListBlock.craft = {
  displayName: 'Grille Tarifs',
  props: {
    items: [
      { name: 'Pack Standard', price: '49€', desc: 'Description', featured: false },
      { name: 'Pack Premium', price: '99€', desc: 'Description', featured: true },
    ],
    columns: 3,
  },
  related: { settings: AutoSettingsPanel },
...
export const StarRatingBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ display: 'flex', alignItems: 'center', gap: 6, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      {Array.from({ length: maxStars }, (_, i) => (
        <span
          ...
          style={{
            fontSize: size,
            color: i < Math.floor(rating) ? color : i < rating ? color : '#e2e8f0',
            lineHeight: 1,
          }}
        >
          {i < Math.floor(rating) || (i === Math.floor(rating) && rating % 1 < 0.25)
            ? '★'
            : i < rating
              ? '⯨'
              : '☆'}
      ...
      {showValue && (
        <span style={{ fontSize: size * 0.7, color: '#64748b', fontWeight: 600 }}>
          {rating.toFixed(1)}
        </span>
      )}
    </div>
...
StarRatingBlock.craft = {
  displayName: 'Avis ★',
  props: { rating: 4.5, maxStars: 5, size: 24, color: '#f59e0b', showValue: true },
  related: { settings: AutoSettingsPanel },
};
...
export const SocialIconsBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ display: 'flex', gap, justifyContent: alignment, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      {platforms.map((p: string, i: number) => (
        ...
        >
          {icons[p] || p.charAt(0).toUpperCase()}
        </a>
      ))}
    </div>
  );
  ...
  return (
    ...
    >
      ...
      {buttons.map((b: string, i: number) => (
        ...
        >
          {shareLabels[b] || b.charAt(0).toUpperCase()}
        </a>
      ))}
    </div>
  );
};
ShareButtonsBlock.craft = {
  displayName: 'Partage social',
  props: {
    buttons: ['facebook', 'twitter', 'linkedin', 'whatsapp'],
    size: 36,
    label: 'Partager :',
...
export const BreadcrumbsBlock = (props: any) => {
  ...
  return (
    <nav
      ...
      style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      {items.map((item: any, i: number) => (
        <React.Fragment key={i}>
          ...
          {i < items.length - 1 ? (
            <a href={item.url} style={{ color, textDecoration: 'none', fontSize }}>
              {item.label}
            </a>
          ) : (
...
export const AuthorBoxBlock = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h4 style={{ margin: '0 0 2px', fontSize: 15, fontWeight: 600 }}>{name}</h4>
        <p style={{ margin: '0 0 4px', fontSize: 12, color: accentColor, fontWeight: 500 }}>
          {role}
        </p>
        <p style={{ margin: 0, fontSize: 12, color: '#475569', lineHeight: 1.6 }}>{bio}</p>
      </div>
    </div>
  );
};
AuthorBoxBlock.craft = {
  displayName: 'Boîte Auteur',
  props: {
    name: 'Jean Dupont',
    role: 'Auteur',
    bio: 'Biographie…',
...
export const LogoGridBlock = (props: any) => {
  const {
    logos = [
      'https://placehold.co/120x60/94a3b8/ffffff?text=Logo+1',
      'https://placehold.co/120x60/64748b/ffffff?text=Logo+2',
      'https://placehold.co/120x60/475569/ffffff?text=Logo+3',
    ],
    columns = 4,
    gap = 24,
    grayscale = true,
...
CookieConsentBlock.craft = {
  displayName: 'Cookies Consent',
  props: {
...
export const BackToTopBlock = (props: any) => {
  ...
  useEffect(() => {
    const h = () => setVisible(window.scrollY > showAfter);
  ...
  return (
    <div
      ...
      className={'proquelec-builder-node transition ' + u.className}
    >
      {label || icon}
    </div>
  );
};
BackToTopBlock.craft = {
  displayName: 'Retour Haut',
  props: {
    icon: '↑',
    label: '',
    bgColor: '#0f172a',
...
export const SearchBlock = (props: any) => {
  ...
  return (
    <form
      ...
      style={{ display: 'flex', maxWidth: width, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      <input
        value={query}
...
export const AvatarBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ display: 'inline-flex', ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      {src ? (
        <img
...
AvatarBlock.craft = {
  displayName: 'Avatar',
  props: { src: '', name: 'User', size: 48, shape: 'circle', borderColor: '#e2e8f0' },
  related: { settings: AutoSettingsPanel },
};
...
export const BadgeBlock = (props: any) => {
  ...
  const sizes: any = {
    ...
    lg: { fontSize: 14, padding: '4px 14px' },
  };
...
BadgeBlock.craft = {
  displayName: 'Badge',
  props: { text: 'Nouveau', bgColor: '#2563eb', textColor: '#ffffff', size: 'md' },
  related: { settings: AutoSettingsPanel },
};
// ─────────────────────────────────────────────
  ...
  return (
    <div className="space-y-3">
      <Row>
        ...
        <Select
          value={shape}
          onChange={(e: any) => setProp((p: any) => (p.shape = e.target.value))}
          options={[
      ...
      <Row>
        <Label label="Hauteur (px)" />
        <Input
          type="number"
          value={height}
          onChange={(e: any) => setProp((p: any) => (p.height = parseInt(e.target.value)))}
        />
      </Row>
      <Row>
        <Label label="Couleur" />
      ...
      <Flex>
        <label className="text-xs text-slate-400">
          <input
            type="checkbox"
            checked={flip}
            onChange={(e: any) => setProp((p: any) => (p.flip = e.target.checked))}
            className="mr-1"
          />
          Inverser
        </label>
...
ShapeDividerBlock.craft = {
  displayName: 'Séparateur Forme',
  props: { shape: 'wave', height: 100, color: '#2563eb', flip: false, position: 'bottom' },
  related: { settings: ShapeDividerSettings },
};
...
export const AnimatedHeadlineBlock = (props: any) => {
  ...
  useEffect(() => {
    const i = setInterval(() => setIndex((c) => (c + 1) % animatedWords.length), 2500);
    return () => clearInterval(i);
  ...
  return (
    <h2
      ...
      style={{ fontSize, color, fontWeight: 700, lineHeight: 1.3, ...u.style }}
      className={'proquelec-builder-node m-0 ' + u.className}
    >
      {resolveDynamicContent(beforeText)}&nbsp;
      <span
        style={{ color: accentColor, position: 'relative', display: 'inline-block', minWidth: 100 }}
      >
        {animatedWords[index]}
        <span
          style={{
...
AnimatedHeadlineBlock.craft = {
  displayName: 'Titre animé',
  props: {
    beforeText: 'Nous',
    animatedWords: ['innovons', 'créons', 'transformons'],
    afterText: 'pour vous',
    ...
    >
      {items.map((item: any, i: number) => (
        <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontSize: iconSize, color: iconColor, lineHeight: 1, flexShrink: 0 }}>
            {item.icon}
          </span>
          <span style={{ fontSize: 14, color: '#334155' }}>{resolveDynamicContent(item.text)}</span>
        </li>
      ))}
    </ul>
  );
...
const FeatureListSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <Row>
        <Label label="Éléments (icône|texte par ligne)" />
        <Textarea
          rows={5}
          value={items.map((i: any) => i.icon + '|' + i.text).join('\n')}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.items = parsePipeItems(e.target.value, ([icon, ...textParts], raw) => ({
                icon: icon?.trim() || '⚡',
                text: textParts.join('|').trim() || raw,
              }));
            })
          }
        />
...
FeatureListBlock.craft = {
  displayName: 'Liste fonctionnalités',
  props: {
    items: [
      { icon: '⚡', text: 'Haute performance' },
      { icon: '🔒', text: 'Sécurisé' },
  ...
  related: { settings: FeatureListSettings },
};
...
export const ComplianceChecklistBlock = (props: any) => {
  const {
    ...
    items = [
      {
        status: 'conforme',
        label: 'Tableau électrique identifié',
        detail: 'Repérage clair des départs et protections.',
      },
      {
        status: 'a verifier',
        label: 'Liaisons équipotentielles',
        detail: 'Contrôle visuel et continuité à confirmer.',
      },
      {
        status: 'critique',
        label: 'Protection différentielle',
        detail: 'Point prioritaire avant mise en service.',
      },
    ],
    accentColor = '#2563eb',
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, marginBottom: 24 }}>
        ...
        <h3
          style={{ margin: 0, color: '#0f172a', fontSize: 30, lineHeight: 1.15, fontWeight: 900 }}
        >
          {resolveDynamicContent(title)}
        </h3>
...
const ComplianceChecklistSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Row>
        <Label label="Points (statut|titre|détail)" />
        <Textarea
          rows={6}
          value={(items || [])
            .map((item: any) => `${item.status}|${item.label}|${item.detail}`)
            .join('\n')}
          onChange={(e: any) =>
            setProp(
              (p: any) =>
                (p.items = parsePipeItems(e.target.value, ([status, label, ...detail], raw) => ({
    ...
    steps = [
      {
        phase: '01',
        title: 'Cadrage',
        description: 'Collecte des informations et analyse du besoin.',
        meta: '24 h',
      },
      {
        phase: '02',
        title: 'Contrôle terrain',
        description: 'Inspection technique, relevés et constats.',
        meta: 'Sur site',
      },
      {
        phase: '03',
        title: 'Rapport',
        description: 'Synthèse, réserves et recommandations priorisées.',
        meta: 'Livrable',
      },
      {
        phase: '04',
        title: 'Suivi',
        description: 'Accompagnement jusqu’à la levée des réserves.',
        meta: 'Continu',
      },
    ],
    accentColor = '#f59e0b',
  ...
  return (
    ...
    >
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: 'minmax(220px,0.9fr) minmax(0,1.6fr)',
          gap: 28,
          alignItems: 'start',
        }}
      >
        ...
        <div style={{ display: 'grid', gap: 12 }}>
          {steps.map((step: any, index: number) => (
            ...
            >
              ...
              <div>
                <h4 style={{ margin: 0, fontSize: 16, fontWeight: 850 }}>
              ...
              <span
                style={{ color: accentColor, fontSize: 12, fontWeight: 800, whiteSpace: 'nowrap' }}
              >
...
const AuditProcessSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Row>
        <Label label="Étapes (phase|titre|description|meta)" />
        <Textarea
          rows={7}
          value={(steps || [])
            .map((step: any) => `${step.phase}|${step.title}|${step.description}|${step.meta}`)
            .join('\n')}
          onChange={(e: any) =>
            setProp(
              (p: any) =>
                (p.steps = parsePipeItems(
                  e.target.value,
                  ([phase, title, description, meta], raw) => ({
                    phase: phase || '01',
                    title: title || raw,
    ...
    resources = [
      {
        ...
        description: 'Liste des pièces et informations à réunir.',
        href: '/documents',
        label: 'Consulter',
      },
      {
        ...
        description: 'Transmettre une demande à l’équipe PROQUELEC.',
        href: '/contact',
        label: 'Démarrer',
      },
      {
        ...
        description: 'Accéder aux ressources réglementaires.',
      ...
      >
        {resources.map((resource: any, index: number) => (
          ...
          >
            ...
            <h4 style={{ margin: 0, color: '#0f172a', fontSize: 17, fontWeight: 850 }}>
              {resolveDynamicContent(resource.title)}
            </h4>
            <p style={{ margin: '8px 0 16px', color: '#64748b', fontSize: 13, lineHeight: 1.6 }}>
              {resolveDynamicContent(resource.description)}
            </p>
            <a
              href={resource.href || '#'}
              style={{
...
const ResourceCardsSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Row>
        <Label label="Ressources (type|titre|description|lien|label)" />
        <Textarea
          rows={7}
          value={(resources || [])
            .map(
              (resource: any) =>
                `${resource.type}|${resource.title}|${resource.description}|${resource.href}|${resource.label}`,
            )
            .join('\n')}
          onChange={(e: any) =>
            setProp(
              (p: any) =>
                (p.resources = parsePipeItems(
                  e.target.value,
                  ([type, title, description, href, label], raw) => ({
                    type: type || 'Document',
                    title: title || raw,
                    description: description || '',
                    href: href || '#',
...
// ── 50. TrainingHeroPremiumBlock ──
export const TrainingHeroPremiumBlock = (props: any) => {
  const {
    ...
    audience = 'Installateurs, techniciens, responsables maintenance',
    nextSession = 'Session sur demande',
    imageUrl = '',
    primaryLabel = 'Voir les dates disponibles',
    primaryHref = '/formations',
    secondaryLabel = 'Demander un programme',
        ...
        <div>
          <div
            style={{
              ...
              padding: 22,
              background: imageUrl
                ? `linear-gradient(180deg,rgba(6,17,31,0.25),rgba(6,17,31,0.88)),url(${imageUrl}) center/cover`
                : 'linear-gradient(135deg,rgba(37,99,235,0.34),rgba(251,191,36,0.24))',
...
const TrainingHeroPremiumSettings = () => {
  const {
    actions: { setProp },
    badge,
    title,
...
TrainingHeroPremiumBlock.craft = {
  displayName: 'Hero formation premium',
  props: {
    badge: 'Formation certifiante',
    title: 'Maîtriser la conformité des installations électriques',
    subtitle:
  ...
  related: { settings: TrainingHeroPremiumSettings },
};

// ── 51. TrainingProgramPremiumBlock ──
export const TrainingProgramPremiumBlock = (props: any) => {
  const {
...
TrainingProgramPremiumBlock.craft = {
  displayName: 'Programme formation premium',
  props: {
    title: 'Programme pédagogique',
    subtitle: 'Modules, prérequis et livrables structurés pour une session professionnelle.',
    modules: [
  ...
  related: { settings: TrainingProgramPremiumSettings },
};

// ── 52. PricingComparisonPremiumBlock ──
export const PricingComparisonPremiumBlock = (props: any) => {
  const {
...
PricingComparisonPremiumBlock.craft = {
  displayName: 'Comparatif tarifs premium',
  props: {
    title: 'Comparer les offres',
    subtitle: 'Des formules lisibles pour choisir le bon niveau d’accompagnement.',
    plans: [
...
// ── 54. CertificationRequirementsPremiumBlock ──
export const CertificationRequirementsPremiumBlock = (props: any) => {
  const {
...
CertificationRequirementsPremiumBlock.craft = {
  ...
  related: { settings: CertificationRequirementsPremiumSettings },
};

// ── 55. FAQPremiumBlock ──
export const FAQPremiumBlock = (props: any) => {
  const {
...
FAQPremiumBlock.craft = {
  displayName: 'FAQ premium',
  props: {
    title: 'Questions fréquentes',
    subtitle: 'Réponses claires pour réduire les frictions avant contact ou inscription.',
    categories: ['Contrôle', 'Formation', 'Documents', 'Délais'],
  ...
  related: { settings: FAQPremiumSettings },
};

// ── 56. TestimonialsPremiumBlock ──
export const TestimonialsPremiumBlock = (props: any) => {
  const {
...
TestimonialsPremiumBlock.craft = {
  displayName: 'Témoignages premium',
  props: {
    title: 'Ils nous font confiance',
    subtitle: 'Des retours d’expérience pour valoriser la qualité de l’accompagnement PROQUELEC.',
    rating: 4.8,
  ...
  related: { settings: TestimonialsPremiumSettings },
};

// ── 57. WhyProquelecPremiumBlock ──
export const WhyProquelecPremiumBlock = (props: any) => {
  const {
    title = 'Un tiers de confiance pour la qualité électrique',
    ...
    stats = [
      ...
      { value: '500+', label: 'Dossiers suivis' },
...
WhyProquelecPremiumBlock.craft = {
  displayName: 'Pourquoi PROQUELEC premium',
  props: {
    title: 'Un tiers de confiance pour la qualité électrique',
    subtitle: 'Expliquez clairement la valeur institutionnelle de PROQUELEC.',
    promise: 'Faire progresser la qualité des installations électriques au Sénégal.',
  ...
  related: { settings: WhyProquelecPremiumSettings },
};
...
ParallaxContainerBlock.craft = {
  displayName: 'Conteneur Parallaxe',
  props: { backgroundImage: '', overlayColor: 'rgba(0,0,0,0.5)', speed: 0.5, minHeight: 400 },
  related: { settings: AutoSettingsPanel },
};
    ...
    >
      <div
        style={{
          ...
          borderRadius: height > 3 ? '0 3px 3px 0' : 0,
        }}
      />
    </div>
  );
};
ScrollProgressBlock.craft = {
  displayName: 'Barre progression',
  props: { position: 'top', height: 4, bgColor: '#2563eb', trackColor: '#e2e8f0', zIndex: 9999 },
  related: { settings: AutoSettingsPanel },
};
...
export const ImageAccordionBlock = (props: any) => {
  const {
    images = [
      'https://placehold.co/300x400/2563eb/ffffff?text=1',
      'https://placehold.co/300x400/1e293b/ffffff?text=2',
      'https://placehold.co/300x400/475569/ffffff?text=3',
    ],
    height = 400,
  } = props;
  const {
  ...
  return (
    <div
      ...
      style={{ display: 'flex', height, overflow: 'hidden', borderRadius: 8, ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
      {images.map((src: string, i: number) => (
        <div
...
ImageAccordionBlock.craft = {
  displayName: 'Accordéon Images',
  props: {
    images: [
      'https://placehold.co/300x400/2563eb/ffffff?text=1',
      'https://placehold.co/300x400/1e293b/ffffff?text=2',
      ...
      {pages.map((p) => (
        <button
          ...
          style={{
            ...
            height: s,
            borderRadius: s / 2,
            border: p === currentPage ? '2px solid ' + color : '1px solid #e2e8f0',
            background: p === currentPage ? color : 'white',
...
PaginationBlock.craft = {
  displayName: 'Pagination',
  props: { totalPages: 5, currentPage: 1, color: '#2563eb', size: 'md' },
  related: { settings: AutoSettingsPanel },
};
...
StickyContainerBlock.craft = {
  displayName: 'Conteneur Sticky',
  props: { top: 0, zIndex: 100, backgroundColor: '#ffffff', shadow: true },
  related: { settings: AutoSettingsPanel },
};
...
export const ParticlesBlock = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ position: 'relative', width: '100%', height: 200, overflow: 'hidden', ...u.style }}
      className={'proquelec-builder-node ' + u.className}
    >
...
ParticlesBlock.craft = {
  displayName: 'Particules',
  props: { count: 30, color: '#2563eb', speed: 1, sizeRange: 3, connectLines: false },
  related: { settings: AutoSettingsPanel },
};
  ...
  return (
    <nav
      ...
      style={{
        ...
        borderRadius: 8,
        padding: 16,
        position: sticky ? ('sticky' as any) : 'relative',
    ...
    >
      ...
      {headings.length === 0 && (
        <p className="text-xs text-slate-400 italic">
          Ajoutez des titres (H1-H6) sur la page pour générer la table des matières.
        </p>
      )}
      <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
        {headings.map((h, i) => (
          <li key={h.id} style={{ paddingLeft: (h.level - 1) * 16, marginBottom: 4 }}>
            ...
            >
              {numbered && (
                <span style={{ fontSize: 10, color: '#94a3b8', fontWeight: 600, minWidth: 20 }}>
                  {i + 1}.
                </span>
              )}
              <span>{h.text}</span>
...
const TableOfContentsSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Row>
        <Label label="Niveau max." />
        <Select
          value={maxLevel}
          onChange={(e: any) => setProp((p: any) => (p.maxLevel = parseInt(e.target.value)))}
          options={[
            { value: 2, label: 'H2' },
            { value: 3, label: 'H3' },
            { value: 4, label: 'H4' },
            { value: 6, label: 'Tous (H1-H6)' },
          ]}
        />
      </Row>
      <Row>
      ...
      <Row>
        ...
        <Color
          value={containerBg}
          onChange={(e: any) => setProp((p: any) => (p.containerBg = e.target.value))}
        />
      </Row>
      <Row>
        <Label label="Couleur titre" />
        <Color
          value={titleColor}
          onChange={(e: any) => setProp((p: any) => (p.titleColor = e.target.value))}
        />
      </Row>
      <Row>
        <Label label="Couleur liens" />
        <Color
          value={linkColor}
          onChange={(e: any) => setProp((p: any) => (p.linkColor = e.target.value))}
        />
      </Row>
    </div>
  );
};
TableOfContentsBlock.craft = {
  displayName: 'Table des matières',
  props: {
    title: 'Table des matières',
    maxLevel: 3,
    numbered: true,
