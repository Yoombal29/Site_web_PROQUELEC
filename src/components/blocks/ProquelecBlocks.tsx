...
const ContainerSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Couleur de fond" />
        <SettingsColor
      ...
      <SettingsRow>
        <SettingsLabel label="Padding H (px)" />
        <SettingsInput
          type="number"
          value={padding}
          onChange={(e: any) => setProp((p: any) => (p.padding = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Padding V (px)" />
        <SettingsInput
          type="number"
          value={paddingY}
          onChange={(e: any) => setProp((p: any) => (p.paddingY = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsSelect
          value={maxWidth}
          onChange={(e: any) => setProp((p: any) => (p.maxWidth = e.target.value))}
          options={[
            { value: '100%', label: 'Pleine largeur' },
            { value: '1280px', label: '1280px (XL)' },
...
ContainerBlock.craft = {
  ...
  props: { padding: 20, backgroundColor: '#ffffff', maxWidth: '100%' },
...
export const HeroBlock = (props: any) => {
  ...
  if (slidesJson) {
    try {
      customSlides = JSON.parse(slidesJson);
    } catch {
      /* ignore */
    }
  }
  ...
  return (
    <div className="space-y-3">
      ...
      {tab === 'content' && (
        <div className="space-y-3">
          <div className="text-[10px] text-slate-500 bg-[#0d0d1a] rounded-lg px-3 py-2 leading-relaxed">
            Ces valeurs remplacent le <strong className="text-slate-300">premier slide</strong> de
            la base de données. Laissez vide pour utiliser les données DB.
          </div>
          <SettingsRow>
            <SettingsLabel label="Badge (texte pillule)" />
            <SettingsInput
              value={badgeText}
              onChange={(e: any) => setProp((p: any) => (p.badgeText = e.target.value))}
            />
          </SettingsRow>
          <SettingsRow>
            ...
            <SettingsInput
              value={headline}
              onChange={(e: any) => setProp((p: any) => (p.headline = e.target.value))}
            />
          </SettingsRow>
          <SettingsRow>
            ...
            <SettingsTextarea
              rows={3}
              value={subheadline}
              onChange={(e: any) => setProp((p: any) => (p.subheadline = e.target.value))}
            />
          </SettingsRow>
          <SettingsRow>
          ...
          <SettingsRow>
            ...
            <SettingsInput
              ...
              onChange={(e: any) => setProp((p: any) => (p.secondaryCtaLabel = e.target.value))}
            />
          </SettingsRow>
          <SettingsRow>
            ...
            <SettingsInput
              ...
              onChange={(e: any) => setProp((p: any) => (p.secondaryCtaHref = e.target.value))}
            />
          </SettingsRow>
        </div>
      )}
        ...
        <div className="space-y-3">
          ...
          <SettingsRow>
            ...
            <SettingsInput
              ...
              onChange={(e: any) =>
                setProp((p: any) => (p.autoplayInterval = Number(e.target.value)))
              }
            />
          </SettingsRow>
          <SettingsRow>
          ...
          <div className="text-[10px] text-slate-500 bg-[#0d0d1a] rounded-lg px-3 py-2 leading-relaxed">
            Pour changer l'image de fond des slides, utilisez l'onglet{' '}
            <strong className="text-slate-300">Slides</strong> ou modifiez les données via le
            panneau Admin → Accueil → Slides.
          </div>
        </div>
      )}
      ...
      {tab === 'slides' && (
        <div className="space-y-3">
          <div className="text-[10px] text-slate-500 bg-[#0d0d1a] rounded-lg px-3 py-2 leading-relaxed">
            Collez un tableau JSON de slides pour{' '}
            <strong className="text-slate-300">remplacer entièrement</strong> les slides DB. Chaque
            slide doit avoir : <code className="text-amber-400">badge</code>,{' '}
            <code className="text-amber-400">title</code>,{' '}
            <code className="text-amber-400">subtitle</code>,{' '}
            <code className="text-amber-400">background_url</code>,{' '}
            <code className="text-amber-400">cta_text</code>,{' '}
            <code className="text-amber-400">cta_link</code>.
          </div>
  ...
  return (
    ...
    >
      <a
        ...
        className={`inline-block ${sizeClasses[size] ?? sizeClasses.md} ${roundedClasses[rounded]} font-semibold transition-all hover:opacity-90 hover:scale-105 shadow-md ${fullWidth ? 'w-full text-center' : ''}`}
      >
        {resolvedLabel}
      </a>
    </div>
...
const ButtonSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Texte" />
        <SettingsInput
          value={label}
          onChange={(e: any) => setProp((p: any) => (p.label = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Lien (href)" />
        <SettingsInput
          value={href}
          onChange={(e: any) => setProp((p: any) => (p.href = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Couleur fond" />
        <SettingsColor
          value={backgroundColor}
          onChange={(e: any) => setProp((p: any) => (p.backgroundColor = e.target.value))}
        />
      ...
      <SettingsRow>
        ...
        <SettingsSelect
          value={size}
          onChange={(e: any) => setProp((p: any) => (p.size = e.target.value))}
          options={[
      ...
      <SettingsRow>
        ...
        <SettingsSelect
          value={rounded}
          onChange={(e: any) => setProp((p: any) => (p.rounded = e.target.value))}
          options={[
  ...
  return (
    ...
    >
      <img
        src={src}
        alt={alt}
        style={{ objectFit, height: `${height}px` }}
        className={`w-full ${roundedClasses[rounded]} shadow-sm`}
        loading="lazy"
      />
...
const ImageSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="URL de l'image" />
        <SettingsInput
          value={src}
          onChange={(e: any) => setProp((p: any) => (p.src = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Médiathèque" />
        <MediaPickerButton
          onSelect={(url: string) => setProp((p: any) => (p.src = url))}
          label="Choisir depuis la médiathèque"
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Texte alternatif" />
        <SettingsInput
          value={alt}
          onChange={(e: any) => setProp((p: any) => (p.alt = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Légende" />
        <SettingsInput
          value={caption}
          onChange={(e: any) => setProp((p: any) => (p.caption = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Hauteur (px)" />
        <SettingsInput
          type="number"
          value={height}
      ...
      <SettingsRow>
        ...
        <SettingsSelect
          value={objectFit}
          onChange={(e: any) => setProp((p: any) => (p.objectFit = e.target.value))}
          options={[
      ...
      <div className="flex flex-wrap justify-center gap-12 max-w-4xl mx-auto">
        {stats.map((s, i) => (
          <div key={i} className="text-center">
            <div style={{ color: accentColor }} className="text-5xl font-black mb-2">
              {s.value}
            </div>
...
const StatsSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Stat 1 — Valeur" />
        <SettingsInput
          value={stat1Value}
          onChange={(e: any) => setProp((p: any) => (p.stat1Value = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Stat 1 — Label" />
        <SettingsInput
          value={stat1Label}
          onChange={(e: any) => setProp((p: any) => (p.stat1Label = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Stat 2 — Valeur" />
        <SettingsInput
          value={stat2Value}
          onChange={(e: any) => setProp((p: any) => (p.stat2Value = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Stat 2 — Label" />
        <SettingsInput
          value={stat2Label}
          onChange={(e: any) => setProp((p: any) => (p.stat2Label = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Stat 3 — Valeur" />
        <SettingsInput
          value={stat3Value}
          onChange={(e: any) => setProp((p: any) => (p.stat3Value = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Stat 3 — Label" />
        <SettingsInput
          value={stat3Label}
          onChange={(e: any) => setProp((p: any) => (p.stat3Label = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Fond" />
        <SettingsColor
          value={backgroundColor}
          onChange={(e: any) => setProp((p: any) => (p.backgroundColor = e.target.value))}
        />
...
const VideoSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="URL YouTube / Vidéo" />
        <SettingsInput
          value={src}
          onChange={(e: any) => setProp((p: any) => (p.src = e.target.value))}
        />
      ...
      <SettingsRow>
        ...
        <SettingsSelect
          value={aspectRatio}
          onChange={(e: any) => setProp((p: any) => (p.aspectRatio = e.target.value))}
          options={[
...
VideoBlock.craft = {
  displayName: 'Vidéo',
  props: { src: '', caption: '', aspectRatio: '16/9' },
...
export const DividerBlock = (props: any) => {
  ...
  return (
    ...
    >
      <hr
        style={{ borderColor: color, borderTopWidth: `${thickness}px`, borderTopStyle: lineStyle }}
      />
    </div>
  );
};
const DividerSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <SettingsRow>
        <SettingsLabel label="Épaisseur (px)" />
        <SettingsInput
          type="number"
          min={1}
          max={10}
          value={thickness}
          onChange={(e: any) => setProp((p: any) => (p.thickness = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Marge V (px)" />
        <SettingsInput
          type="number"
          value={marginY}
          onChange={(e: any) => setProp((p: any) => (p.marginY = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsSelect
          value={lineStyle}
          onChange={(e: any) => setProp((p: any) => (p.style = e.target.value))}
          options={[
...
DividerBlock.craft = {
  ...
  props: { color: '#e2e8f0', thickness: 1, marginY: 24, style: 'solid' },
...
export const CardBlock = (props: any) => {
  ...
  return (
    ...
    >
      ...
      {title && (
        <h3 style={{ color: accentColor }} className="font-bold text-lg mb-1">
          {title}
        </h3>
      )}
...
const CardSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Icône (Emoji)" />
        <SettingsInput
          value={icon}
          onChange={(e: any) => setProp((p: any) => (p.icon = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
      ...
      <SettingsRow>
        <SettingsLabel label="Sous-titre" />
        <SettingsInput
          value={subtitle}
      ...
      <SettingsRow>
        ...
        <SettingsTextarea
          value={text}
          onChange={(e: any) => setProp((p: any) => (p.text = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Fond" />
    ...
    >
      {children ??
        Array.from({ length: columns }).map((_, i) => (
          <div
            key={i}
            className="min-h-[60px] border-2 border-dashed border-slate-200 rounded flex items-center justify-center text-slate-400 text-sm"
          >
            Colonne {i + 1}
          </div>
        ))}
...
const ColumnsSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <SettingsRow>
        <SettingsLabel label="Espacement (px)" />
        <SettingsInput
          type="number"
          value={gap}
    ...
    >
      ...
      <div className="space-y-4">
        <input
          ...
          className="w-full px-4 py-3 border border-slate-200 rounded-lg bg-white text-sm"
          readOnly
        />
        <input
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-4 py-3 border border-slate-200 rounded-lg bg-white text-sm resize-none"
          readOnly
        />
...
const FormSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <SettingsRow>
        <SettingsLabel label="Texte bouton" />
        <SettingsInput
          value={submitText}
          onChange={(e: any) => setProp((p: any) => (p.submitText = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Fond" />
...
export const TestimonialsBlock = (props: any) => {
  const {
    ...
    testimonial1Role = 'Directrice Technique',
    testimonial1Text = 'PROQUELEC a transformé notre approche de la sécurité électrique. Service exceptionnel !',
    testimonial1Stars = 5,
    testimonial2Name = 'Jean Dupont',
    testimonial2Role = 'Chef de projet',
    testimonial2Text = 'Équipe professionnelle, résultats au-delà de nos attentes. Je recommande vivement.',
    testimonial2Stars = 5,
    ...
    >
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {testimonials.map((t, i) => (
          <div
            key={i}
            className="bg-white/10 backdrop-blur border border-white/10 rounded-2xl p-8 hover:bg-white/15 transition-colors"
          >
            <div className="flex gap-1 mb-4">
              {Array.from({ length: 5 }).map((_, si) => (
                <span
                  key={si}
                  style={{ color: si < t.stars ? '#f59e0b' : '#374151' }}
                  className="text-xl"
                >
                  ★
                </span>
            ...
            <blockquote
              ...
              className="text-base mb-6 leading-relaxed italic opacity-90"
            >
              "{t.text}"
            </blockquote>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div style={{ color: textColor }} className="font-semibold text-sm">
                  {t.name}
                </div>
                <div style={{ color: textColor }} className="text-xs opacity-60">
                  {t.role}
                </div>
              </div>
            </div>
...
const TestimonialsSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <div className="text-[10px] text-indigo-400 font-bold uppercase tracking-wider mt-2">
        Témoignage 1
      </div>
      <SettingsRow>
        <SettingsLabel label="Nom" />
        <SettingsInput
          value={testimonial1Name}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial1Name = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Rôle" />
        <SettingsInput
          value={testimonial1Role}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial1Role = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsTextarea
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial1Text = e.target.value;
            })
          }
        />
      </SettingsRow>
      ...
      <SettingsRow>
        ...
        <SettingsInput
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial2Name = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsInput
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial2Role = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsTextarea
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.testimonial2Text = e.target.value;
            })
          }
        />
      </SettingsRow>
...
TestimonialsBlock.craft = {
  ...
  props: {
    testimonial1Name: 'Sophie Martin',
    testimonial1Role: 'Directrice Technique',
    testimonial1Text: 'PROQUELEC a transformé notre approche.',
    testimonial1Stars: 5,
    testimonial2Name: 'Jean Dupont',
    testimonial2Role: 'Chef de projet',
    testimonial2Text: 'Équipe professionnelle, résultats au-delà de nos attentes.',
    testimonial2Stars: 5,
    backgroundColor: '#0f172a',
    textColor: '#ffffff',
  },
...
export const PricingBlock = (props: any) => {
  const {
    ...
    plan1Price = '199',
    plan1Period = 'mois',
    plan1Features = 'Audit de base\nRapport PDF\nSupport email',
    plan1Cta = 'Choisir',
    plan2Name = 'Professionnel',
    plan2Price = '499',
    plan2Period = 'mois',
    plan2Features = 'Audit complet\nRapport détaillé\nSupport prioritaire\nFormation équipe',
    plan2Cta = 'Choisir',
    plan2Featured = true,
    plan3Name = 'Entreprise',
    plan3Price = 'Sur devis',
    plan3Period = '',
    plan3Features = 'Audit multi-sites\nRapport personnalisé\nSupport dédié\nFormation + Suivi',
    plan3Cta = 'Contacter',
    accentColor = '#2563eb',
  } = props;
  const {
    ...
    >
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        {plans.map((plan, i) => (
          <div
            key={i}
            className={`relative rounded-2xl p-8 border-2 transition-all ${plan.featured ? 'shadow-2xl scale-105' : 'border-slate-100 shadow-sm hover:shadow-md bg-white'}`}
            style={plan.featured ? { borderColor: accentColor, backgroundColor: accentColor } : {}}
          >
            {plan.featured && (
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-amber-900 text-[10px] font-black uppercase px-3 py-1 rounded-full tracking-wider">
                Populaire
              </div>
            )}
            <div
              className={`text-sm font-bold mb-4 ${plan.featured ? 'text-blue-100' : 'text-slate-500'}`}
            >
              {plan.name}
            </div>
            <div
              className={`flex items-baseline gap-1 mb-6 ${plan.featured ? 'text-white' : 'text-slate-900'}`}
            >
              <span className="text-4xl font-black">{plan.price}</span>
              {plan.period && (
                <span className={`text-sm ${plan.featured ? 'text-blue-100' : 'text-slate-400'}`}>
                  /{plan.period}
                </span>
              )}
            </div>
            <ul className="space-y-2.5 mb-8">
              {plan.features
                ...
                .map((feat: string, fi: number) => (
                  <li
                    key={fi}
                    className={`flex items-start gap-2 text-sm ${plan.featured ? 'text-blue-100' : 'text-slate-600'}`}
                  >
            ...
            <a
              href="#"
              className={`block text-center py-3 px-6 rounded-xl font-bold text-sm transition-all hover:opacity-90 ${plan.featured ? 'bg-white text-blue-700' : 'text-white'}`}
    ...
    <div className="space-y-3">
      ...
      <SettingsRow>
        ...
        <SettingsInput
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.plan1Name = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Prix" />
        <SettingsInput
          value={plan1Price}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.plan1Price = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Fonctionnalités (1/ligne)" />
        <SettingsTextarea
          rows={4}
          value={plan1Features}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.plan1Features = e.target.value;
            })
          }
        />
      </SettingsRow>
      ...
      <SettingsRow>
        ...
        <SettingsTextarea
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.plan2Features = e.target.value;
            })
          }
        />
      </SettingsRow>
      ...
      <SettingsRow>
        ...
        <SettingsTextarea
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.plan3Features = e.target.value;
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Couleur accent" />
        <SettingsColor
          value={accentColor}
          onChange={(e: any) =>
            setProp((p: any) => {
...
const DEFAULT_FAQ = [
  {
    q: "Quels types d'audits réalisez-vous ?",
    a: 'Nous réalisons des audits électriques complets conformes aux normes NF C 15-100.',
  },
  {
    q: "Quelle est la durée d'un audit ?",
    a: 'Comptez une demi-journée pour un logement et une journée pour un local professionnel.',
  },
  {
    q: 'Comment obtenir un devis ?',
    a: 'Contactez-nous via notre formulaire. Nous répondons dans les 24h avec un devis personnalisé.',
  },
];
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {items.map((item: any, i: number) => (
            <div
              key={i}
              className={`border rounded-xl overflow-hidden transition-all ${openIndex === i ? 'border-blue-200 shadow-sm' : 'border-slate-100'}`}
            >
              <button
              ...
              >
                ...
                <span
                  className="text-xl shrink-0 ml-3"
                  style={{
                    color: accentColor,
...
const AccordionSettings = () => {
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        <SettingsLabel label="Titre de section" />
        <SettingsInput
          value={title}
          onChange={(e: any) =>
            setProp((p: any) => {
...
AccordionBlock.craft = {
  displayName: 'Accordéon FAQ',
  props: { title: 'Questions Fréquentes', items: DEFAULT_FAQ, accentColor: '#2563eb' },
...
export const IconBoxBlock = (props: any) => {
  const {
    icon = '⚡',
    title = 'Expertise Électrique',
    text = "Notre équipe certifiée intervient sur tous types d'installations électriques.",
    layout = 'top',
    accentColor = '#2563eb',
    backgroundColor = '#ffffff',
    textColor = '#0f172a',
  ...
  return (
    ...
    >
      ...
      <div>
        <h4 style={{ color: accentColor }} className="font-black text-lg mb-2">
          {title}
        </h4>
        <p style={{ color: textColor }} className="text-sm leading-relaxed opacity-80">
          {text}
        </p>
      </div>
    </div>
...
const IconBoxSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <SettingsRow>
        <SettingsLabel label="Description" />
        <SettingsTextarea
          value={text}
          onChange={(e: any) =>
            setProp((p: any) => {
      ...
      <SettingsRow>
        <SettingsLabel label="Disposition" />
        <SettingsSelect
          value={layout}
          onChange={(e: any) =>
            setProp((p: any) => {
...
export const CounterBlock = (props: any) => {
  ...
  return (
    ...
    >
      <div style={{ color: accentColor }} className="text-7xl font-black mb-2 tabular-nums">
        {value}
        {suffix}
      </div>
...
const CounterSettings = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <SettingsRow>
        <SettingsLabel label="Suffixe" />
        <SettingsInput
          value={suffix}
          onChange={(e: any) =>
            setProp((p: any) => {
              p.suffix = e.target.value;
            })
          }
        />
      </SettingsRow>
...
CounterBlock.craft = {
  ...
  related: { settings: CounterSettings },
};
    ...
    <div className="space-y-3">
      ...
      <SettingsRow>
        ...
        <SettingsInput
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.gap = parseInt(e.target.value);
            })
          }
        />
      </SettingsRow>
      <SettingsRow>
        <SettingsLabel label="Arrondi (px)" />
        <SettingsInput
          type="number"
          min={0}
          max={32}
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.rounded = parseInt(e.target.value);
            })
          }
        />
      </SettingsRow>
...
GalleryBlock.craft = {
  displayName: 'Galerie',
  props: { columns: 3, gap: 16, rounded: 8, images: DEFAULT_GALLERY },
    ...
    <div className="space-y-3">
      <SettingsRow>
        ...
        <SettingsInput
          ...
          onChange={(e: any) =>
            setProp((p: any) => {
              p.padding = parseInt(e.target.value);
            })
          }
        />
      </SettingsRow>
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        ...
        <SettingsSelect
          value={String(tabsCount)}
          onChange={(e: any) => setProp((p: any) => (p.tabsCount = parseInt(e.target.value)))}
          options={[
            { value: '2', label: '2' },
            { value: '3', label: '3' },
            { value: '4', label: '4' },
      ...
      <SettingsRow>
        ...
        <SettingsInput
          value={tabTitles}
          onChange={(e: any) => setProp((p: any) => (p.tabTitles = e.target.value))}
        />
      </SettingsRow>
    </div>
  );
...
export const CarouselBlock = (props: any) => {
  ...
  return (
    ...
    >
      {imgList.length === 0 ? (
        <div className="bg-slate-800 text-slate-400 py-20 text-center text-sm">
    ...
    <div className="space-y-3">
      <SettingsRow>
        ...
        <SettingsTextarea
          rows={4}
          value={images}
          onChange={(e: any) => setProp((p: any) => (p.images = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsSelect
          ...
          onChange={(e: any) => setProp((p: any) => (p.autoplay = e.target.value === 'true'))}
          options={[
...
CarouselBlock.craft = {
  ...
  props: {
    images:
      'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800,https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=800,https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800',
    autoplay: true,
    interval: 4000,
  },
...
export const ProgressBarBlock = (props: any) => {
  ...
  return (
    ...
    >
      <div
        className="flex justify-between items-center mb-1.5 text-sm font-bold"
        style={{ color: textColor }}
      >
        <span>{label}</span>
    ...
    <div className="space-y-3">
      ...
      <SettingsRow>
        ...
        <SettingsInput
          ...
          max={100}
          value={percentage}
          onChange={(e: any) => setProp((p: any) => (p.percentage = parseInt(e.target.value)))}
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsColor
          value={barColor}
          onChange={(e: any) => setProp((p: any) => (p.barColor = e.target.value))}
        />
      </SettingsRow>
      <SettingsRow>
        ...
        <SettingsColor
          value={trackColor}
          onChange={(e: any) => setProp((p: any) => (p.trackColor = e.target.value))}
        />
      </SettingsRow>
    </div>
  );
  ...
  return (
    <div className="space-y-3">
      <SettingsRow>
        ...
        <SettingsSelect
          value={type}
          onChange={(e: any) => setProp((p: any) => (p.type = e.target.value))}
          options={[
      ...
      <SettingsRow>
        ...
        <SettingsTextarea
          rows={3}
          value={message}
          onChange={(e: any) => setProp((p: any) => (p.message = e.target.value))}
        />
      </SettingsRow>
    </div>
  );
