...
export const LatestNews = () => {
  ...
  if (isLoading) {
    return (
      <section className="py-20 px-4" style={sectionStyle}>
      ...
      <section className="py-20 px-4" style={sectionStyle}>
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600" style={{ fontFamily: settings?.font_family }}>
            ...
            >
              <div className="h-full bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 hover:border-proqblue/20 overflow-hidden flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  {/* Title */}
                  <h3 
                    className="text-lg font-bold mb-2 line-clamp-2 group-hover:text-proqblue transition-colors"
                    style={{ fontFamily: settings?.font_family }}
                  >
                    {post.title}
                  </h3>
