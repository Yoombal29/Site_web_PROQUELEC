      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
        <div className="text-center max-w-md bg-white p-10 rounded-3xl shadow-xl border border-blue-100 italic">
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Votre demande d'inscription en tant que partenaire est en cours de validation par nos
            administrateurs. Vous recevrez un accès complet dès que votre compte sera approuvé.
          </p>
          <a
            href="/"
            className="inline-block bg-slate-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-all"
