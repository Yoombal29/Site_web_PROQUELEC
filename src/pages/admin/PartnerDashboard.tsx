...
export default function PartnerDashboard() {
  ...
  // Defense in depth : vérification du rôle
  if (!isLoading && role !== 'partner' && role !== 'admin' && role !== 'superadmin') {
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Gérez votre présence et vos interventions.
                </p>
              </div>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl mb-10 border border-slate-100">
              <p className="text-slate-600 text-sm leading-relaxed">
                Notez que les nouveaux événements doivent être validés par l'administration avant
          ...
          <div className="space-y-8">
            <div>
              <div className="flex items-center gap-3 px-4 mb-8">
                ...
                <div>
                  <div className="text-xs font-black text-blue-600 uppercase tracking-widest leading-none mb-1">
                    Partenaire Espace
                  </div>
