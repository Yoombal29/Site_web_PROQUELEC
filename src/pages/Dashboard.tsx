            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Gérez le catalogue des équipements électriques proposés par PROQUELEC
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Créer une nouvelle fiche d'équipement avec photos et spécifications
                  </p>
                ...
                <div className="p-4 bg-secondary/50 rounded-lg border border-border">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Gérer les catégories et sous-catégories d'équipements
                  </p>
                  <button className="px-4 py-2 bg-primary text-primary-foreground rounded hover:opacity-90 transition">
                    Gérer catégories
                  </button>
              ...
              <div className="p-4 bg-amber-500/10 rounded-lg border border-amber-500/20">
                <h4 className="font-semibold text-amber-600 dark:text-amber-400 mb-2">
                  ℹ️ Équipements actuels
                </h4>
                <p className="text-sm text-amber-700 dark:text-amber-300">
                  Vous pouvez commencer par importer des équipements depuis un fichier CSV ou en les
          ...
          <section className="bg-card p-6 rounded-lg shadow-md animate-fade-in border border-border">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Gérez la base de données des normes électriques applicables au Sénégal
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-4 bg-primary/5 rounded-lg border border-primary/10">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Normes pour les installations électriques fixes
                  </p>
                ...
                <div className="p-4 bg-primary/5 rounded-lg border border-primary/10">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Normes de sécurité et protection contre les surcharges
                  </p>
                  <button className="text-sm text-primary hover:underline">Gérer →</button>
                </div>
              </div>
      ...
      case 'download_buttons':
        return (
          <div className="p-6 text-center">
            <p className="text-slate-500">Téléchargements (section désactivée)</p>
          </div>
        );
      case 'features':
        return (
          <div className="p-6 text-center">
            <p className="text-slate-500">Fonctionnalités (section désactivée)</p>
          </div>
        );
      ...
      <main className="flex flex-col lg:flex-row pt-20 lg:pt-28 min-h-screen">
        {isLoadingAdmin ? (
          ...
          <>
            ...
            <div className="flex-1 w-full max-w-none px-4 sm:px-6 lg:px-8 py-8 overflow-x-hidden">
                  ...
                  <p className="text-muted-foreground text-base md:text-lg animate-fade-in max-w-2xl leading-relaxed">
                    {activeTab === 'overview' ? (
                      <>
                        ...
                        <span className="font-bold text-proqblue">{user.email?.split('@')[0]}</span>
                        . Gérez le portail PROQUELEC avec précision.
                      </>
                    ) : (
                      <>
                        Configuration de la section{' '}
                        <strong>{menuItems.find((item) => item.id === activeTab)?.label}</strong>.
                      </>
                    )}
                  </p>
                </div>
              ...
              <div className="text-center text-primary opacity-70 text-sm pb-8 mt-8">
                ⚠️ Vous avez accès à tous les paramètres d'administration. Utilisez ces outils avec
                précaution.
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-center w-full mt-24 gap-4">
            ...
            <div className="text-xl text-red-700 font-semibold">Accès refusé</div>
