...
import { ChevronDown, AlertCircle, CheckCircle2, Zap, RotateCcw, RotateCw, History } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-2 text-slate-300 hover:text-white bg-slate-700/40 hover:bg-slate-600/60 border border-slate-600/40 rounded-lg transition-all duration-200 hover:border-slate-500/60 group"
                title="Historique des modifications et sauvegardes"
              >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Debug Console temporairement désactivée */}
        </main>
