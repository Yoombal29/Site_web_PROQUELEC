...
const SectionBenefits = () => {
  const benefits = [
    { icon: ShieldCheck, title: "Gage de Sécurité", desc: "Le label certifie que vos installations respectent les normes NS 01-001 et le décret n°1333 de 2017 sur la conformité électrique." },
    { icon: BarChart3, title: "Accès aux Marchés", desc: "La labellisation PROQUELEC est reconnue et souvent exigée dans les appels d'offre publics et les projets d'infrastructure." },
    { icon: Users, title: "Confiance Clients", desc: "Affichez votre certification pour inspirer confiance. Une installation labellisée rassure les clients sur la qualité des travaux." },
    { icon: Award, title: "Avantage Concurrentiel", desc: "Distinguez-vous sur le marché sénégalais en prouvant votre engagement envers l'excellence et les standards internationaux." },
  ];
    ...
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <p className="text-xl text-slate-600 font-light">
          Le Label PROQUELEC est bien plus qu'une distinction — c'est une preuve de votre engagement pour la sécurité.
        </p>
      </div>
      ...
      <div className="space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-xl text-slate-600 font-light italic">
            Pour obtenir le label PROQUELEC, votre dossier doit satisfaire ces exigences fondamentales.
          </p>
        </div>
...
export default function Labels() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'benefits': return <SectionBenefits />;
      case 'criteria': return <SectionCriteria />;
      default: return <SectionBenefits />;
    }
  };
        ...
        <section className="bg-slate-900 pt-32 pb-48 relative overflow-hidden">
          ...
          <div className="container max-w-7xl mx-auto px-4 relative z-10 text-center space-y-8">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto font-light">
              Affirmez votre professionnalisme et gagnez la confiance de vos clients avec le label de référence nationale.
            </p>
          </div>
        </section>
