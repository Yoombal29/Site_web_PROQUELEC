...
export const premiumApps: ProquelecApp[] = [
  ...
  },
  {
    ...
    description: 'Vérification complète du système de mise à la terre selon NF C 15-100.',
    icon: CircuitBoard,
    category: 'premium',
    status: 'active',
    norme: 'NF C 15-100',
  ...
  },
  {
    ...
    description:
      'Recherche dans les normes électriques NS 01-001, NF C 15-100, IEC et tableaux de câbles.',
    icon: Database,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
