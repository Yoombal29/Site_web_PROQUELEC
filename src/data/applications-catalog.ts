/**
 * CATALOGUE DES APPLICATIONS PROQUELEC
...
export const freeApps: ProquelecApp[] = [
  ...
  },
  {
    ...
    description: 'Dictionnaire des termes techniques avec plus de 50 définitions de la NS 01-001.',
    icon: BookOpen,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    description: '18 questions-réponses sur la NS 01-001 et les normes électriques sénégalaises.',
    icon: HelpCircle,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    description:
      'Calculez la puissance totale de vos appareils électriques avec la formule P = U × I.',
    icon: Gauge,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  {
    id: 'label-qualite',
    title: 'Demande de Label Qualité',
    description: 'Formulaire de demande de certification PROQUELEC (Bronze, Argent, Or).',
    icon: ShieldCheck,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    description: 'Téléchargez guides techniques et mémentos électriques PROQUELEC.',
    icon: BookOpen,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    title: 'Simulateur Consommation Électrique',
    description: 'Estimez la consommation de votre logement et obtenez des conseils personnalisés.',
    icon: TrendingUp,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    title: 'Diagnostic Sécurité Interactif',
    description:
      'Diagnostic électrique guidé : symptômes, causes, solutions et génération de rapport.',
    icon: AlertTriangle,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
  ...
  },
  {
    ...
    title: 'Checklist Sécurité Électrique',
    description:
      'Évaluez la conformité de votre installation avec une checklist interactive notée.',
    icon: ClipboardCheck,
    category: 'free',
    status: 'active',
    group: 'Grand Public',
...
export const premiumApps: ProquelecApp[] = [
  ...
  },
  {
    ...
    description: 'Vérification complète du système de mise à la terre selon NS 01-001.',
    icon: CircuitBoard,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  },
  {
    ...
    description: 'Vérifiez la prise de terre et la conformité avec NS 01-001.',
    icon: ShieldCheck,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  },
  {
    ...
    description: 'Audit automatique de conformité NS 01-001, IEC et normes locales.',
    icon: ClipboardCheck,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  // ─── FORMATION & DOCUMENTS ───
  {
    ...
    description:
      'Architecture Cerveau Gauche/Droit. Fusionne la recherche intuitive (Embeddings) et la rigueur logique (Règles).',
    icon: Brain,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  },
  {
    ...
    description:
      "Le cœur de l'intelligence (Port 8000). Indexation vectorielle des 1994 articles de la NS 01-001.",
    icon: Cpu,
    category: 'premium',
    status: 'active',
    group: 'IA & Outils',
  ...
  },
  {
    ...
    description:
      'Le protocole de réponse en 5 étapes : Identité, Ingénierie, Conformité, Sénégal, Terrain.',
    icon: ShieldCheck,
    category: 'premium',
    status: 'active',
    group: 'IA & Outils',
  ...
  },
  {
    ...
    description:
      'Cerveau Gauche : Formules, matrices de décision et checklists injectés dans le pipeline Haystack.',
    icon: Calculator,
    category: 'premium',
    status: 'active',
    group: 'IA & Outils',
  ...
  },
  {
    ...
    description: 'Calculez la section de câble optimale selon puissance, longueur et matériau.',
    icon: Cable,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  },
  {
    ...
    description: 'Calculez vos besoins en panneaux solaires, batteries et régulateur.',
    icon: Sun,
    category: 'premium',
    status: 'active',
    group: 'Électriciens',
  ...
  },
  {
    ...
    description: 'Guide complet sur la prise de terre et les disjoncteurs différentiels.',
    icon: Shield,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  {
    id: 'base-normative',
    title: 'Base Normative Interactive',
    description:
      'Recherche dans les normes électriques NS 01-001, NS 01-001, IEC et tableaux de câbles.',
    icon: Database,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001',
  ...
  {
    id: 'generateur-devis',
    title: 'Générateur de Devis Électrique',
    description:
      'Créez des devis professionnels avec catalogue produits, TVA, QR code et export Word.',
    icon: FileText,
    category: 'premium',
    status: 'active',
    group: 'Électriciens',
  ...
  // --- NOUVEAUX OUTILS IA & ABONNEMENT ---
  {
    id: 'expert-chat-ia',
    title: 'Expert Chat IA',
    description: 'Assistant normatif avec RAG vectoriel. Posez vos questions sur les normes.',
    icon: MessageSquare,
    category: 'premium',
    status: 'active',
    norme: 'NS 01-001 / NF C18-510 / NF C15-100',
    group: 'IA & Outils',
    route: '/expert-lab/chat',
  },
  {
    id: 'rag-recherche',
    title: 'Recherche Normative RAG',
    description: 'Moteur de recherche vectoriel dans 20 sources documentaires.',
    icon: Search,
    category: 'free',
    status: 'active',
    norme: 'Toutes normes',
  ...
  },
  {
    ...
    description: 'Accedez a tous les outils PROQUELEC : mensuel, annuel ou a vie.',
    icon: Crown,
    category: 'premium',
    status: 'active',
    group: 'Services',
  ...
  },
  {
    id: 'providers-ia',
    title: 'Providers IA',
    description: 'Configurez 12 fournisseurs d\'IA (Groq, OpenAI, Anthropic, Gemini...).',
    icon: Cpu,
    category: 'internal',
    status: 'active',
    group: 'IA & Outils',
  ...
  },
  {
    ...
    description: 'Guide intelligent du site : calculs électriques, schémas, normes NS 01-001 et NS 01-001. Alimenté par Groq.',
    icon: MessageCircle,
    category: 'premium',
    status: 'active',
    group: 'Électriciens',
