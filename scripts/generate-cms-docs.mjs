...
const content = `# Guide admin CMS PROQUELEC
...
fs.writeFileSync(path.join(docsDir, 'guide-admin-cms-proquelec.md'), content, 'utf8');
fs.writeFileSync(path.join(publicDocsDir, 'guide-admin-cms-proquelec.md'), content, 'utf8');

console.log('Guide admin CMS généré.');
