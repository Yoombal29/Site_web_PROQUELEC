-- ========================================================
-- ROBUST CONTENT UPDATE: Expertises & Solutions
-- ========================================================

-- Update the page content whether it's called 'produits', 'expertises-technique' or 'expertises-techniques'
UPDATE public.pages
SET 
  title = 'Expertises & Solutions',
  slug = 'expertises-techniques', -- Standardize to plural
  ...
  is_published = true,
  updated_at = now()
WHERE slug IN ('produits', 'expertises-technique', 'expertises-techniques');
