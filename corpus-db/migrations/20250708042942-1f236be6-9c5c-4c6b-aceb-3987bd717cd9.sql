...
ALTER PUBLICATION proquelec_realtime ADD TABLE public.construction_mode;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.performance_metrics;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.electrical_certifications;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.professional_training;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.training_registrations;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.electrical_equipment;
ALTER PUBLICATION proquelec_realtime ADD TABLE public.electrical_standards;
